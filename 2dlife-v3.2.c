...
// Version 3.2 (as of 7/24/2026)
// New: Check for operating system
// New: Added --version argument to comply with GNU standard
...
char *argv[];
{
  ...
  // Check OS
  if(checkOS() != 2) {
    printf("This software is written for the Linux operating system!\n");
    return(1);
  }
